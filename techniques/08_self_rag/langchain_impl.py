"""
Self-RAG: Self-reflective retrieval and generation — LangChain Implementation
==================================================================================
LLM decides if retrieval is needed, evaluates doc relevance, critiques its own output, and iterates if unsatisfied.
...
class SelfRAGLangChain(BaseRAG):
    ...
    def _build_pipeline(self) -> None:
        ...
        logger.info(f"[self_rag/LC] Initialized (stub)")
    ...
    def index(self, documents: List[str], metadatas: Optional[List[Dict]] = None) -> None:
        ...
        raise NotImplementedError(
            "Implement index() for SelfRAGLangChain. "
            "See 01_naive_rag/langchain_impl.py for reference pattern."
        )

    def _query(self, question: str) -> RAGResult:
        """TODO: Implement the full self_rag query pipeline."""
        raise NotImplementedError(
            "Implement _query() for SelfRAGLangChain. "
            "See 01_naive_rag/langchain_impl.py for reference pattern."
        )
...
if __name__ == "__main__":
    ...
    print("SelfRAGLangChain stub — implement _build_pipeline, index, and _query first.")
