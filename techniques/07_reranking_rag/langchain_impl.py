"""
Reranking RAG: Cross-encoder reranking after vector retrieval — LangChain Implementation
=============================================================================================
Retrieves a large candidate pool, then applies a cross-encoder to rerank by true relevance before final generation.
...
class RerankingRAGLangChain(BaseRAG):
    ...
    def _build_pipeline(self) -> None:
        ...
        logger.info(f"[reranking_rag/LC] Initialized (stub)")
    ...
    def index(self, documents: List[str], metadatas: Optional[List[Dict]] = None) -> None:
        ...
        raise NotImplementedError(
            "Implement index() for RerankingRAGLangChain. "
            "See 01_naive_rag/langchain_impl.py for reference pattern."
        )

    def _query(self, question: str) -> RAGResult:
        """TODO: Implement the full reranking_rag query pipeline."""
        raise NotImplementedError(
            "Implement _query() for RerankingRAGLangChain. "
            "See 01_naive_rag/langchain_impl.py for reference pattern."
        )
...
if __name__ == "__main__":
    ...
    print("RerankingRAGLangChain stub — implement _build_pipeline, index, and _query first.")
