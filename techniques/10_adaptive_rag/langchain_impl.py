...
==========================================================================================
Classifies query complexity and routes to the appropriate RAG strategy: no-retrieval,
naive, or advanced/agentic.
...
class AdaptiveRAGLangChain(BaseRAG):
    """
    Classifies query complexity and routes to the appropriate RAG strategy:
    no-retrieval, naive, or advanced/agentic.
    ...
    def _build_pipeline(self) -> None:
        ...
        logger.info("[adaptive_rag/LC] Initialized (stub)")
