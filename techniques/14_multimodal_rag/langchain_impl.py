"""
Multi-modal RAG: Text + image + table retrieval — LangChain Implementation
===============================================================================
Processes and retrieves across text, images, and tables by generating summaries/captions for non-text content.
...
class MultimodalRAGLangChain(BaseRAG):
    ...
    def _build_pipeline(self) -> None:
        ...
        logger.info(f"[multimodal_rag/LC] Initialized (stub)")
